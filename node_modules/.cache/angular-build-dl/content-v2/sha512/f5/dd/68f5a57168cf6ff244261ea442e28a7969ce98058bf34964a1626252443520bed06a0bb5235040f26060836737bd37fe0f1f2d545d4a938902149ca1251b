...
const { Camera } = _capacitor_core__WEBPACK_IMPORTED_MODULE_1__["Plugins"];
let PhotoService = class PhotoService {
    ...
    savePicture(cameraPhoto) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const savedFile = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_1__["Filesystem"].writeFile({
                path: fileName,
                data: base64Data,
    ...
    loadSaved() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            for (const photo of this.photos) {
                ...
                const readFile = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_1__["Filesystem"].readFile({
                    path: photo.filepath,
                    directory: _capacitor_core__WEBPACK_IMPORTED_MODULE_1__["FilesystemDirectory"].Data
                });
